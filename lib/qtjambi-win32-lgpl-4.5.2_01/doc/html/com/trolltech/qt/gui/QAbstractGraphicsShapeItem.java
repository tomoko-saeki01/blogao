...
/**
The QAbstractGraphicsShapeItem class provides a common base for all path items. This class does not fully implement an item by itself; in particular, it does not implement {@link com.trolltech.qt.gui.QGraphicsItem#boundingRect() boundingRect()} and {@link com.trolltech.qt.gui.QGraphicsItem#paint(com.trolltech.qt.gui.QPainter, com.trolltech.qt.gui.QStyleOptionGraphicsItem) paint()}, which are inherited by {@link com.trolltech.qt.gui.QGraphicsItem QGraphicsItem}. <p>You can subclass this item to provide a simple base implementation of accessors for the item's pen and brush. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsRectItem QGraphicsRectItem}, {@link com.trolltech.qt.gui.QGraphicsEllipseItem QGraphicsEllipseItem}, {@link com.trolltech.qt.gui.QGraphicsPathItem QGraphicsPathItem}, {@link com.trolltech.qt.gui.QGraphicsPolygonItem QGraphicsPolygonItem}, {@link com.trolltech.qt.gui.QGraphicsTextItem QGraphicsTextItem}, {@link com.trolltech.qt.gui.QGraphicsLineItem QGraphicsLineItem}, {@link com.trolltech.qt.gui.QGraphicsPixmapItem QGraphicsPixmapItem}, and {@link <a href="../graphicsview.html">The Graphics View Framework</a>}. <br></DD></DT>
*/
@QtJambiGeneratedClass
public abstract class QAbstractGraphicsShapeItem extends com.trolltech.qt.QtJambiObject
    implements com.trolltech.qt.gui.QGraphicsItemInterface
{
    ...
    private static class ConcreteWrapper extends com.trolltech.qt.gui.QAbstractGraphicsShapeItem {
...
*/
    ...
    public QAbstractGraphicsShapeItem(com.trolltech.qt.gui.QGraphicsItemInterface parent) {
...
*/
    ...
    public QAbstractGraphicsShapeItem(com.trolltech.qt.gui.QGraphicsItemInterface parent, com.trolltech.qt.gui.QGraphicsScene scene){
        super((QPrivateConstructor)null);
        __qt_QAbstractGraphicsShapeItem_QGraphicsItem_QGraphicsScene(parent == null ? 0 : parent.nativeId(), scene == null ? 0 : scene.nativeId());
    ...
    native void __qt_QAbstractGraphicsShapeItem_QGraphicsItem_QGraphicsScene(long parent, long scene);
...
/**
Returns the item's brush, or an empty brush if no brush has been set. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QAbstractGraphicsShapeItem#setBrush(com.trolltech.qt.gui.QBrush) setBrush()}. <br></DD></DT>
*/
...
/**
Returns the item's pen. If no pen has been set, this function returns QPen(), a default black solid line pen with 0 width. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QAbstractGraphicsShapeItem#setPen(com.trolltech.qt.gui.QPen) setPen()}. <br></DD></DT>
*/
...
/**
Sets the item's brush to <tt>brush</tt>. <p>The item's brush is used to fill the item. <p>If you use a brush with a {@link com.trolltech.qt.gui.QGradient QGradient}, the gradient is relative to the item's coordinate system. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QAbstractGraphicsShapeItem#brush() brush()}. <br></DD></DT>
*/
...
/**
Sets the pen for this item to <tt>pen</tt>. <p>The pen is used to draw the item's outline. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QAbstractGraphicsShapeItem#pen() pen()}. <br></DD></DT>
*/
...
*/
    ...
    public static native QAbstractGraphicsShapeItem fromNativePointer(QNativePointer nativePointer);
...
*/
    ...
    protected QAbstractGraphicsShapeItem(QPrivateConstructor p) { super(p); } 
