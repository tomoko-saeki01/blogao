...
/**
The QGraphicsLineItem class provides a line item that you can add to a {@link com.trolltech.qt.gui.QGraphicsScene QGraphicsScene}. To set the item's line, pass a {@link com.trolltech.qt.gui.QLineF QLineF} to QGraphicsLineItem's constructor, or call the {@link com.trolltech.qt.gui.QGraphicsLineItem#setLine(com.trolltech.qt.gui.QLineF) setLine()} function. The {@link com.trolltech.qt.gui.QGraphicsLineItem#line() line()} function returns the current line. By default the line is black with a width of 0, but you can change this by calling {@link com.trolltech.qt.gui.QGraphicsLineItem#setPen(com.trolltech.qt.gui.QPen) setPen()}. <br><center><img src="../images/graphicsview-lineitem.png"></center><br> QGraphicsLineItem uses the line and the pen width to provide a reasonable implementation of {@link com.trolltech.qt.gui.QGraphicsItem#boundingRect() boundingRect()}, {@link com.trolltech.qt.gui.QGraphicsItem#shape() shape()}, and {@link com.trolltech.qt.gui.QGraphicsItem#contains(com.trolltech.qt.core.QPointF) contains()}. The {@link com.trolltech.qt.gui.QGraphicsItem#paint(com.trolltech.qt.gui.QPainter, com.trolltech.qt.gui.QStyleOptionGraphicsItem) paint()} function draws the line using the item's associated pen. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsPathItem QGraphicsPathItem}, {@link com.trolltech.qt.gui.QGraphicsRectItem QGraphicsRectItem}, {@link com.trolltech.qt.gui.QGraphicsEllipseItem QGraphicsEllipseItem}, {@link com.trolltech.qt.gui.QGraphicsTextItem QGraphicsTextItem}, {@link com.trolltech.qt.gui.QGraphicsPolygonItem QGraphicsPolygonItem}, {@link com.trolltech.qt.gui.QGraphicsPixmapItem QGraphicsPixmapItem}, and {@link <a href="../graphicsview.html">The Graphics View Framework</a>}. <br></DD></DT>
*/
@QtJambiGeneratedClass
public class QGraphicsLineItem extends com.trolltech.qt.QtJambiObject
...
/**
<brief>Returns the QGraphicsLineItem$enum_1 constant with the specified <tt>int</tt>.</brief>
*/
...
/**
Constructs a QGraphicsLineItem. <tt>parent</tt> is passed to {@link com.trolltech.qt.gui.QGraphicsItem QGraphicsItem}'s constructor. The item is added to <tt>scene</tt>. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsScene#addItem(com.trolltech.qt.gui.QGraphicsItemInterface) QGraphicsScene::addItem()}. <br></DD></DT>
*/

    public QGraphicsLineItem(com.trolltech.qt.gui.QGraphicsItemInterface parent) {
...
*/
    ...
    public QGraphicsLineItem(com.trolltech.qt.gui.QGraphicsItemInterface parent, com.trolltech.qt.gui.QGraphicsScene scene){
        super((QPrivateConstructor)null);
        __qt_QGraphicsLineItem_QGraphicsItem_QGraphicsScene(parent == null ? 0 : parent.nativeId(), scene == null ? 0 : scene.nativeId());
        if (parent != null) disableGarbageCollection();


    }

    native void __qt_QGraphicsLineItem_QGraphicsItem_QGraphicsScene(long parent, long scene);
...
*/
    ...
    public QGraphicsLineItem(com.trolltech.qt.gui.QLineF line, com.trolltech.qt.gui.QGraphicsItemInterface parent) {
        this(line, parent, (com.trolltech.qt.gui.QGraphicsScene)null);
    }
...
*/
    ...
    public QGraphicsLineItem(com.trolltech.qt.gui.QLineF line) {
        this(line, (com.trolltech.qt.gui.QGraphicsItem)null, (com.trolltech.qt.gui.QGraphicsScene)null);
    }
/**
Creates a new QGraphicsLineItem from <tt>line</tt> with the specified
...
*/
    ...
    public QGraphicsLineItem(com.trolltech.qt.gui.QLineF line, com.trolltech.qt.gui.QGraphicsItemInterface parent, com.trolltech.qt.gui.QGraphicsScene scene){
        super((QPrivateConstructor)null);
        __qt_QGraphicsLineItem_QLineF_QGraphicsItem_QGraphicsScene(line == null ? 0 : line.nativeId(), parent == null ? 0 : parent.nativeId(), scene == null ? 0 : scene.nativeId());
        if (parent != null) disableGarbageCollection();


    }

    native void __qt_QGraphicsLineItem_QLineF_QGraphicsItem_QGraphicsScene(long line, long parent, long scene);
...
*/
    ...
    public QGraphicsLineItem(double x1, double y1, double x2, double y2, com.trolltech.qt.gui.QGraphicsItemInterface parent) {
        this(x1, y1, x2, y2, parent, (com.trolltech.qt.gui.QGraphicsScene)null);
    }
...
*/
    ...
    public QGraphicsLineItem(double x1, double y1, double x2, double y2) {
        this(x1, y1, x2, y2, (com.trolltech.qt.gui.QGraphicsItem)null, (com.trolltech.qt.gui.QGraphicsScene)null);
    }
/**
This is equal to QGraphicsLineItem(new QLineF(<tt>x1</tt>, <tt>y1</tt>,
...
*/
    ...
    public QGraphicsLineItem(double x1, double y1, double x2, double y2, com.trolltech.qt.gui.QGraphicsItemInterface parent, com.trolltech.qt.gui.QGraphicsScene scene){
        super((QPrivateConstructor)null);
        __qt_QGraphicsLineItem_double_double_double_double_QGraphicsItem_QGraphicsScene(x1, y1, x2, y2, parent == null ? 0 : parent.nativeId(), scene == null ? 0 : scene.nativeId());
        if (parent != null) disableGarbageCollection();


    }

    native void __qt_QGraphicsLineItem_double_double_double_double_QGraphicsItem_QGraphicsScene(double x1, double y1, double x2, double y2, long parent, long scene);
...
/**
Returns the item's line, or a null line if no line has been set. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsLineItem#setLine(com.trolltech.qt.gui.QLineF) setLine()}. <br></DD></DT>
*/

    @QtBlockedSlot
    public final com.trolltech.qt.gui.QLineF line()    {
        if (nativeId() == 0)
            throw new QNoNativeResourcesException("Function call on incomplete object of type: " +getClass().getName());
        return __qt_line(nativeId());
    }
    @QtBlockedSlot
    native com.trolltech.qt.gui.QLineF __qt_line(long __this__nativeId);
...
/**
Returns the item's pen, or a black solid 0-width pen if no pen has been set. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsLineItem#setPen(com.trolltech.qt.gui.QPen) setPen()}. <br></DD></DT>
*/
...
/**
Sets the item's line to be the given <tt>line</tt>. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsLineItem#line() line()}. <br></DD></DT>
*/

    @QtBlockedSlot
    public final void setLine(com.trolltech.qt.gui.QLineF line)    {
        if (nativeId() == 0)
            throw new QNoNativeResourcesException("Function call on incomplete object of type: " +getClass().getName());
        __qt_setLine_QLineF(nativeId(), line == null ? 0 : line.nativeId());
    }
    @QtBlockedSlot
    native void __qt_setLine_QLineF(long __this__nativeId, long line);

/**
This is an overloaded member function, provided for convenience. <p>Sets the item's line to be the line between (<tt>x1</tt>, <tt>y1</tt>) and (<tt>x2</tt>, <tt>y2</tt>). <p>This is the same as calling <tt>setLine(QLineF(x1, y1, x2, y2))</tt>.
*/
...
/**
Sets the item's pen to <tt>pen</tt>. If no pen is set, the line will be painted using a black solid 0-width pen. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsLineItem#pen() pen()}. <br></DD></DT>
*/
...
*/
    ...
    public static native QGraphicsLineItem fromNativePointer(QNativePointer nativePointer);
