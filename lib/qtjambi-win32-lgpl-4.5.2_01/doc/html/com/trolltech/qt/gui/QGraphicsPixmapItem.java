...
/**
The QGraphicsPixmapItem class provides a pixmap item that you can add to a {@link com.trolltech.qt.gui.QGraphicsScene QGraphicsScene}. To set the item's pixmap, pass a {@link com.trolltech.qt.gui.QPixmap QPixmap} to QGraphicsPixmapItem's constructor, or call the {@link com.trolltech.qt.gui.QGraphicsPixmapItem#setPixmap(com.trolltech.qt.gui.QPixmap) setPixmap()} function. The {@link com.trolltech.qt.gui.QGraphicsPixmapItem#pixmap() pixmap()} function returns the current pixmap. <p>QGraphicsPixmapItem uses pixmap's optional alpha mask to provide a reasonable implementation of {@link com.trolltech.qt.gui.QGraphicsItem#boundingRect() boundingRect()}, {@link com.trolltech.qt.gui.QGraphicsItem#shape() shape()}, and {@link com.trolltech.qt.gui.QGraphicsItem#contains(com.trolltech.qt.core.QPointF) contains()}. <br><center><img src="../images/graphicsview-pixmapitem.png"></center><br> The pixmap is drawn at the item's (0, 0) coordinate, as returned by {@link com.trolltech.qt.gui.QGraphicsPixmapItem#offset() offset()}. You can change the drawing offset by calling {@link com.trolltech.qt.gui.QGraphicsPixmapItem#setOffset(com.trolltech.qt.core.QPointF) setOffset()}. <p>You can set the pixmap's transformation mode by calling {@link com.trolltech.qt.gui.QGraphicsPixmapItem#setTransformationMode(com.trolltech.qt.core.Qt.TransformationMode) setTransformationMode()}. By default, {@link com.trolltech.qt.core.Qt.TransformationMode Qt::FastTransformation } is used, which provides fast, non-smooth scaling. {@link com.trolltech.qt.core.Qt.TransformationMode Qt::SmoothTransformation } enables {@link com.trolltech.qt.gui.QPainter.RenderHint QPainter::SmoothPixmapTransform } on the painter, and the quality depends on the platform and viewport. The result is usually not as good as calling QPixmap::scale() directly. Call {@link com.trolltech.qt.gui.QGraphicsPixmapItem#transformationMode() transformationMode()} to get the current transformation mode for the item. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsPathItem QGraphicsPathItem}, {@link com.trolltech.qt.gui.QGraphicsRectItem QGraphicsRectItem}, {@link com.trolltech.qt.gui.QGraphicsEllipseItem QGraphicsEllipseItem}, {@link com.trolltech.qt.gui.QGraphicsTextItem QGraphicsTextItem}, {@link com.trolltech.qt.gui.QGraphicsPolygonItem QGraphicsPolygonItem}, {@link com.trolltech.qt.gui.QGraphicsLineItem QGraphicsLineItem}, and {@link <a href="../graphicsview.html">The Graphics View Framework</a>}. <br></DD></DT>
*/
@QtJambiGeneratedClass
public class QGraphicsPixmapItem extends com.trolltech.qt.QtJambiObject
...
/**
This enum describes how {@link com.trolltech.qt.gui.QGraphicsPixmapItem QGraphicsPixmapItem} calculates its shape and opaque area. <p>The default value is {@link com.trolltech.qt.gui.QGraphicsPixmapItem.ShapeMode MaskShape }.
*/

    public enum ShapeMode implements com.trolltech.qt.QtEnumerator {
/**
 The shape is determined by calling {@link com.trolltech.qt.gui.QPixmap#mask() QPixmap::mask()}. This shape includes only the opaque pixels of the pixmap. Because the shape is more complex, however, it can be slower than the other modes, and uses more memory.
*/
...
*/
        ...
        BoundingRectShape(1),
/**
 The shape is determine by calling {@link com.trolltech.qt.gui.QPixmap#createHeuristicMask() QPixmap::createHeuristicMask()}. The performance and memory consumption is similar to {@link com.trolltech.qt.gui.QGraphicsPixmapItem.ShapeMode MaskShape }.
*/

        HeuristicMaskShape(2);

        ShapeMode(int value) { this.value = value; }
/**
...
/**
<brief>Returns the QGraphicsPixmapItem$ShapeMode constant with the specified <tt>int</tt>.</brief>
*/

        public static ShapeMode resolve(int value) {
            return (ShapeMode) resolve_internal(value);
        }
        private static Object resolve_internal(int value) {
            switch (value) {
            case 0: return MaskShape;
            case 1: return BoundingRectShape;
            case 2: return HeuristicMaskShape;
            }
...
/**
<brief>Returns the QGraphicsPixmapItem$enum_1 constant with the specified <tt>int</tt>.</brief>
*/
...
/**
Constructs a QGraphicsPixmapItem. <tt>parent</tt> is passed to {@link com.trolltech.qt.gui.QGraphicsItem QGraphicsItem}'s constructor.The item is then added to scene. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsScene#addItem(com.trolltech.qt.gui.QGraphicsItemInterface) QGraphicsScene::addItem()}. <br></DD></DT>
*/

    public QGraphicsPixmapItem(com.trolltech.qt.gui.QGraphicsItemInterface parent) {
...
*/
    ...
    public QGraphicsPixmapItem(com.trolltech.qt.gui.QGraphicsItemInterface parent, com.trolltech.qt.gui.QGraphicsScene scene){
        super((QPrivateConstructor)null);
        __qt_QGraphicsPixmapItem_QGraphicsItem_QGraphicsScene(parent == null ? 0 : parent.nativeId(), scene == null ? 0 : scene.nativeId());
        if (parent != null) disableGarbageCollection();


    }

    native void __qt_QGraphicsPixmapItem_QGraphicsItem_QGraphicsScene(long parent, long scene);
...
*/
    ...
    public QGraphicsPixmapItem(com.trolltech.qt.gui.QPixmap pixmap, com.trolltech.qt.gui.QGraphicsItemInterface parent) {
        this(pixmap, parent, (com.trolltech.qt.gui.QGraphicsScene)null);
    }
...
*/
    ...
    public QGraphicsPixmapItem(com.trolltech.qt.gui.QPixmap pixmap) {
        this(pixmap, (com.trolltech.qt.gui.QGraphicsItem)null, (com.trolltech.qt.gui.QGraphicsScene)null);
    }
/**
...
*/
    ...
    public QGraphicsPixmapItem(com.trolltech.qt.gui.QPixmap pixmap, com.trolltech.qt.gui.QGraphicsItemInterface parent, com.trolltech.qt.gui.QGraphicsScene scene){
        super((QPrivateConstructor)null);
        __qt_QGraphicsPixmapItem_QPixmap_QGraphicsItem_QGraphicsScene(pixmap == null ? 0 : pixmap.nativeId(), parent == null ? 0 : parent.nativeId(), scene == null ? 0 : scene.nativeId());
        if (parent != null) disableGarbageCollection();


    }

    native void __qt_QGraphicsPixmapItem_QPixmap_QGraphicsItem_QGraphicsScene(long pixmap, long parent, long scene);
...
/**
Returns the pixmap item's offset, which defines the point of the top-left corner of the pixmap, in local coordinates. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsPixmapItem#setOffset(com.trolltech.qt.core.QPointF) setOffset()}. <br></DD></DT>
*/
...
/**
Returns the item's pixmap, or an invalid {@link com.trolltech.qt.gui.QPixmap QPixmap} if no pixmap has been set. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsPixmapItem#setPixmap(com.trolltech.qt.gui.QPixmap) setPixmap()}. <br></DD></DT>
*/
...
/**
Sets the pixmap item's offset to <tt>offset</tt>. QGraphicsPixmapItem will draw its pixmap using <tt>offset</tt> for its top-left corner. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsPixmapItem#offset() offset()}. <br></DD></DT>
*/
...
/**
This convenience function is equivalent to calling setOffset({@link com.trolltech.qt.core.QPointF QPointF}(<tt>x</tt>, <tt>y</tt>)).
*/
    ...
    public final void setOffset(double x, double y)    {
        if (nativeId() == 0)
            throw new QNoNativeResourcesException("Function call on incomplete object of type: " +getClass().getName());
        __qt_setOffset_double_double(nativeId(), x, y);
    }
    @QtBlockedSlot
    native void __qt_setOffset_double_double(long __this__nativeId, double x, double y);
...
/**
Sets the item's pixmap to <tt>pixmap</tt>. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsPixmapItem#pixmap() pixmap()}. <br></DD></DT>
*/
...
/**
Sets the item's shape mode to <tt>mode</tt>. The shape mode describes how QGraphicsPixmapItem calculates its shape. The default mode is {@link com.trolltech.qt.gui.QGraphicsPixmapItem.ShapeMode MaskShape }. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsPixmapItem#shapeMode() shapeMode()}, and {@link com.trolltech.qt.gui.QGraphicsPixmapItem.ShapeMode ShapeMode }. <br></DD></DT>
*/

    @QtBlockedSlot
    public final void setShapeMode(com.trolltech.qt.gui.QGraphicsPixmapItem.ShapeMode mode)    {
        if (nativeId() == 0)
            throw new QNoNativeResourcesException("Function call on incomplete object of type: " +getClass().getName());
        __qt_setShapeMode_ShapeMode(nativeId(), mode.value());
    }
    @QtBlockedSlot
    native void __qt_setShapeMode_ShapeMode(long __this__nativeId, int mode);
...
/**
Sets the pixmap item's transformation mode to <tt>mode</tt>, and toggles an update of the item. The default mode is {@link com.trolltech.qt.core.Qt.TransformationMode Qt::FastTransformation }, which provides quick transformation with no smoothing. <p>{@link com.trolltech.qt.core.Qt.TransformationMode Qt::SmoothTransformation } enables {@link com.trolltech.qt.gui.QPainter.RenderHint QPainter::SmoothPixmapTransform } on the painter, and the quality depends on the platform and viewport. The result is usually not as good as calling QPixmap::scale() directly. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsPixmapItem#transformationMode() transformationMode()}. <br></DD></DT>
*/

    @QtBlockedSlot
    public final void setTransformationMode(com.trolltech.qt.core.Qt.TransformationMode mode)    {
        if (nativeId() == 0)
            throw new QNoNativeResourcesException("Function call on incomplete object of type: " +getClass().getName());
        __qt_setTransformationMode_TransformationMode(nativeId(), mode.value());
    }
    @QtBlockedSlot
    native void __qt_setTransformationMode_TransformationMode(long __this__nativeId, int mode);
...
/**
Returns the item's shape mode. The shape mode describes how QGraphicsPixmapItem calculates its shape. The default mode is {@link com.trolltech.qt.gui.QGraphicsPixmapItem.ShapeMode MaskShape }. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsPixmapItem#setShapeMode(com.trolltech.qt.gui.QGraphicsPixmapItem.ShapeMode) setShapeMode()}, and {@link com.trolltech.qt.gui.QGraphicsPixmapItem.ShapeMode ShapeMode }. <br></DD></DT>
*/

    @QtBlockedSlot
    public final com.trolltech.qt.gui.QGraphicsPixmapItem.ShapeMode shapeMode()    {
        if (nativeId() == 0)
            throw new QNoNativeResourcesException("Function call on incomplete object of type: " +getClass().getName());
        return com.trolltech.qt.gui.QGraphicsPixmapItem.ShapeMode.resolve(__qt_shapeMode(nativeId()));
    }
    @QtBlockedSlot
    native int __qt_shapeMode(long __this__nativeId);
...
/**
Returns the transformation mode of the pixmap. The default mode is {@link com.trolltech.qt.core.Qt.TransformationMode Qt::FastTransformation }, which provides quick transformation with no smoothing. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsPixmapItem#setTransformationMode(com.trolltech.qt.core.Qt.TransformationMode) setTransformationMode()}. <br></DD></DT>
*/

    @QtBlockedSlot
    public final com.trolltech.qt.core.Qt.TransformationMode transformationMode()    {
        if (nativeId() == 0)
            throw new QNoNativeResourcesException("Function call on incomplete object of type: " +getClass().getName());
        return com.trolltech.qt.core.Qt.TransformationMode.resolve(__qt_transformationMode(nativeId()));
    }
    @QtBlockedSlot
    native int __qt_transformationMode(long __this__nativeId);
...
*/
    ...
    public static native QGraphicsPixmapItem fromNativePointer(QNativePointer nativePointer);
...
*/
    ...
    protected QGraphicsPixmapItem(QPrivateConstructor p) { super(p); } 
