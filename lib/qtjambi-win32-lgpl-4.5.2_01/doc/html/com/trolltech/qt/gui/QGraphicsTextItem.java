...
/**
The QGraphicsTextItem class provides a text item that you can add to a {@link com.trolltech.qt.gui.QGraphicsScene QGraphicsScene} to display formatted text. If you only need to show plain text in an item, consider using {@link com.trolltech.qt.gui.QGraphicsSimpleTextItem QGraphicsSimpleTextItem} instead. <p>To set the item's text, pass a QString to QGraphicsTextItem's constructor, or call {@link com.trolltech.qt.gui.QGraphicsTextItem#setHtml(java.lang.String) setHtml()}/{@link com.trolltech.qt.gui.QGraphicsTextItem#setPlainText(java.lang.String) setPlainText()}. <p>QGraphicsTextItem uses the text's formatted size and the associated font to provide a reasonable implementation of {@link com.trolltech.qt.gui.QGraphicsItem#boundingRect() boundingRect()}, {@link com.trolltech.qt.gui.QGraphicsItem#shape() shape()}, and {@link com.trolltech.qt.gui.QGraphicsItem#contains(com.trolltech.qt.core.QPointF) contains()}. You can set the font by calling {@link com.trolltech.qt.gui.QGraphicsTextItem#setFont(com.trolltech.qt.gui.QFont) setFont()}. <p>It is possible to make the item editable by setting the {@link com.trolltech.qt.core.Qt.TextInteractionFlag Qt::TextEditorInteraction } flag using {@link com.trolltech.qt.gui.QGraphicsTextItem#setTextInteractionFlags(com.trolltech.qt.core.Qt.TextInteractionFlag[]) setTextInteractionFlags()}. <p>The item's preferred text width can be set using {@link com.trolltech.qt.gui.QGraphicsTextItem#setTextWidth(double) setTextWidth()} and obtained using {@link com.trolltech.qt.gui.QGraphicsTextItem#textWidth() textWidth()}. <p><b>Note:</b> In order to align HTML text in the center, the item's text width must be set. <br><center><img src="../images/graphicsview-textitem.png"></center><br> <b>Note:</b>QGraphicsTextItem accepts {@link com.trolltech.qt.gui.QGraphicsItem#acceptHoverEvents() hoover events} by default. You can change this with {@link com.trolltech.qt.gui.QGraphicsItem#setAcceptHoverEvents(boolean) setAcceptHoverEvents()}. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsSimpleTextItem QGraphicsSimpleTextItem}, {@link com.trolltech.qt.gui.QGraphicsPathItem QGraphicsPathItem}, {@link com.trolltech.qt.gui.QGraphicsRectItem QGraphicsRectItem}, {@link com.trolltech.qt.gui.QGraphicsEllipseItem QGraphicsEllipseItem}, {@link com.trolltech.qt.gui.QGraphicsPixmapItem QGraphicsPixmapItem}, {@link com.trolltech.qt.gui.QGraphicsPolygonItem QGraphicsPolygonItem}, {@link com.trolltech.qt.gui.QGraphicsLineItem QGraphicsLineItem}, and {@link <a href="../graphicsview.html">The Graphics View Framework</a>}. <br></DD></DT>
*/
@QtJambiGeneratedClass
public class QGraphicsTextItem extends com.trolltech.qt.core.QObject
...
/**
<brief>Returns the QGraphicsTextItem$enum_1 constant with the specified <tt>int</tt>.</brief>
*/
...
/**
<p>This signal takes 1 generic argument(s). We list their type and the name they go by in the description of this signal. &lt;java.lang.String(named: link)&gt;:<p> This signal is emitted when the user clicks on a link on a text item that enables {@link com.trolltech.qt.core.Qt.TextInteractionFlag Qt::LinksAccessibleByMouse } or {@link com.trolltech.qt.core.Qt.TextInteractionFlag Qt::LinksAccessibleByKeyboard }. <tt>link</tt> is the link that was clicked. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsTextItem#setTextInteractionFlags(com.trolltech.qt.core.Qt.TextInteractionFlag[]) setTextInteractionFlags()}. <br></DD></DT>
*/

    public final Signal1<java.lang.String> linkActivated = new Signal1<java.lang.String>();

    private final void linkActivated(java.lang.String arg__1)    {
        com.trolltech.qt.GeneratorUtilities.threadCheck(this);
        if (nativeId() == 0)
            throw new QNoNativeResourcesException("Function call on incomplete object of type: " +getClass().getName());
        __qt_linkActivated_String(nativeId(), arg__1);
    }
    native void __qt_linkActivated_String(long __this__nativeId, java.lang.String arg__1);
/**
<p>This signal takes 1 generic argument(s). We list their type and the name they go by in the description of this signal. &lt;java.lang.String(named: link)&gt;:<p> This signal is emitted when the user hovers over a link on a text item that enables {@link com.trolltech.qt.core.Qt.TextInteractionFlag Qt::LinksAccessibleByMouse }. <tt>link</tt> is the link that was hovered over. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsTextItem#setTextInteractionFlags(com.trolltech.qt.core.Qt.TextInteractionFlag[]) setTextInteractionFlags()}. <br></DD></DT>
*/

    public final Signal1<java.lang.String> linkHovered = new Signal1<java.lang.String>();

    private final void linkHovered(java.lang.String arg__1)    {
        com.trolltech.qt.GeneratorUtilities.threadCheck(this);
        if (nativeId() == 0)
            throw new QNoNativeResourcesException("Function call on incomplete object of type: " +getClass().getName());
        __qt_linkHovered_String(nativeId(), arg__1);
    }
    native void __qt_linkHovered_String(long __this__nativeId, java.lang.String arg__1);


/**
Constructs a QGraphicsTextItem. <tt>parent</tt> is passed to {@link com.trolltech.qt.gui.QGraphicsItem QGraphicsItem}'s constructor. The item is added to scene. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsScene#addItem(com.trolltech.qt.gui.QGraphicsItemInterface) QGraphicsScene::addItem()}. <br></DD></DT>
*/

    public QGraphicsTextItem(com.trolltech.qt.gui.QGraphicsItemInterface parent) {
...
*/
    ...
    public QGraphicsTextItem(com.trolltech.qt.gui.QGraphicsItemInterface parent, com.trolltech.qt.gui.QGraphicsScene scene){
        super((QPrivateConstructor)null);
        __qt_QGraphicsTextItem_QGraphicsItem_QGraphicsScene(parent == null ? 0 : parent.nativeId(), scene == null ? 0 : scene.nativeId());
        if (parent != null) disableGarbageCollection();


    }

    native void __qt_QGraphicsTextItem_QGraphicsItem_QGraphicsScene(long parent, long scene);
...
*/
    ...
    public QGraphicsTextItem(java.lang.String text, com.trolltech.qt.gui.QGraphicsItemInterface parent) {
...
*/
    ...
    public QGraphicsTextItem(java.lang.String text) {
...
*/
    ...
    public QGraphicsTextItem(java.lang.String text, com.trolltech.qt.gui.QGraphicsItemInterface parent, com.trolltech.qt.gui.QGraphicsScene scene){
        super((QPrivateConstructor)null);
        __qt_QGraphicsTextItem_String_QGraphicsItem_QGraphicsScene(text, parent == null ? 0 : parent.nativeId(), scene == null ? 0 : scene.nativeId());
        if (parent != null) disableGarbageCollection();


    }

    native void __qt_QGraphicsTextItem_String_QGraphicsItem_QGraphicsScene(java.lang.String text, long parent, long scene);
...
/**
Returns the default text color that is used to for unformatted text. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsTextItem#setDefaultTextColor(com.trolltech.qt.gui.QColor) setDefaultTextColor()}. <br></DD></DT>
*/

    @QtBlockedSlot
    public final com.trolltech.qt.gui.QColor defaultTextColor()    {
        com.trolltech.qt.GeneratorUtilities.threadCheck(this);
        if (nativeId() == 0)
            throw new QNoNativeResourcesException("Function call on incomplete object of type: " +getClass().getName());
    ...
    @QtBlockedSlot
    native com.trolltech.qt.gui.QColor __qt_defaultTextColor(long __this__nativeId);
...
/**
Returns the item's text document. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsTextItem#setDocument(com.trolltech.qt.gui.QTextDocument) setDocument()}. <br></DD></DT>
*/
...
/**
Returns the item's font, which is used to render the text. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsTextItem#setFont(com.trolltech.qt.gui.QFont) setFont()}. <br></DD></DT>
*/
...
/**
Specifies whether QGraphicsTextItem should automatically open links using {@link com.trolltech.qt.gui.QDesktopServices#openUrl(com.trolltech.qt.core.QUrl) QDesktopServices::openUrl()} instead of emitting the linkActivated signal. <p>The default value is false.
*/
...
/**
Sets the color for unformatted text to <tt>col</tt>. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsTextItem#defaultTextColor() defaultTextColor()}. <br></DD></DT>
*/

    @QtBlockedSlot
    public final void setDefaultTextColor(com.trolltech.qt.gui.QColor c)    {
        com.trolltech.qt.GeneratorUtilities.threadCheck(this);
        if (nativeId() == 0)
            throw new QNoNativeResourcesException("Function call on incomplete object of type: " +getClass().getName());
        __qt_setDefaultTextColor_QColor(nativeId(), c == null ? 0 : c.nativeId());
    }
    @QtBlockedSlot
    native void __qt_setDefaultTextColor_QColor(long __this__nativeId, long c);

/**
Sets the text document <tt>document</tt> on the item. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsTextItem#document() document()}. <br></DD></DT>
*/
...
/**
Sets the font used to render the text item to <tt>font</tt>. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsTextItem#font() font()}. <br></DD></DT>
*/
...
/**
Sets the item's text to <tt>text</tt>, assuming that text is HTML formatted. If the item has keyboard input focus, this function will also call {@link com.trolltech.qt.gui.QGraphicsItem#ensureVisible(com.trolltech.qt.core.QRectF, int) ensureVisible()} to ensure that the text is visible in all viewports. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsTextItem#toHtml() toHtml()}, {@link com.trolltech.qt.gui.QGraphicsItem#hasFocus() hasFocus()}, and {@link com.trolltech.qt.gui.QGraphicsSimpleTextItem QGraphicsSimpleTextItem}. <br></DD></DT>
*/
...
/**
Sets the item's text to <tt>text</tt>. If the item has keyboard input focus, this function will also call {@link com.trolltech.qt.gui.QGraphicsItem#ensureVisible(com.trolltech.qt.core.QRectF, int) ensureVisible()} to ensure that the text is visible in all viewports. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsTextItem#toHtml() toHtml()}, and {@link com.trolltech.qt.gui.QGraphicsItem#hasFocus() hasFocus()}. <br></DD></DT>
*/
...
/**
This property represents the visible text cursor in an editable text item. <p>By default, if the item's text has not been set, this property contains a null text cursor; otherwise it contains a text cursor placed at the start of the item's document.
*/
...
/**
Sets the flags <tt>flags</tt> to specify how the text item should react to user input. <p>The default for a QGraphicsTextItem is {@link com.trolltech.qt.core.Qt.TextInteractionFlag Qt::NoTextInteraction }. Setting a value different to {@link com.trolltech.qt.core.Qt.TextInteractionFlag Qt::NoTextInteraction } will also set the {@link com.trolltech.qt.gui.QGraphicsItem.GraphicsItemFlag ItemIsFocusable }{@link com.trolltech.qt.gui.QGraphicsItem QGraphicsItem} flag. <p>By default, the text is read-only. To transform the item into an editor, set the {@link com.trolltech.qt.core.Qt.TextInteractionFlag Qt::TextEditable } flag. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsTextItem#textInteractionFlags() textInteractionFlags()}. <br></DD></DT>
*/
...
/**
Sets the preferred width for the item's text. If the actual text is wider than the specified width then it will be broken into multiple lines. <p>If <tt>width</tt> is set to -1 then the text will not be broken into multiple lines unless it is enforced through an explicit line break or a new paragraph. <p>The default value is -1. <p>Note that QGraphicsTextItem keeps a {@link com.trolltech.qt.gui.QTextDocument QTextDocument} internally, which is used to calculate the text width. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsTextItem#textWidth() textWidth()}, and {@link QTextDocument#setTextWidth(double) QTextDocument::setTextWidth()}. <br></DD></DT>
*/
...
/**
Returns the current text interaction flags. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsTextItem#setTextInteractionFlags(com.trolltech.qt.core.Qt.TextInteractionFlag[]) setTextInteractionFlags()}. <br></DD></DT>
*/
...
/**
Returns the text width. <p>The width is calculated with the {@link com.trolltech.qt.gui.QTextDocument QTextDocument} that QGraphicsTextItem keeps internally. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsTextItem#setTextWidth(double) setTextWidth()}, and {@link QTextDocument#textWidth() QTextDocument::textWidth()}. <br></DD></DT>
*/
...
/**
Returns the item's text converted to HTML, or an empty QString if no text has been set. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsTextItem#setHtml(java.lang.String) setHtml()}. <br></DD></DT>
*/
...
/**
Returns the item's text converted to plain text, or an empty QString if no text has been set. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.gui.QGraphicsTextItem#setPlainText(java.lang.String) setPlainText()}. <br></DD></DT>
*/
...
*/
    ...
    public static native QGraphicsTextItem fromNativePointer(QNativePointer nativePointer);
