...
public class AudioChannelDescription extends com.trolltech.qt.QtJambiObject
...
*/
    ...
    public AudioChannelDescription(){
        ...
        __qt_AudioChannelDescription();
    }

    native void __qt_AudioChannelDescription();

/**
This is an overloaded method provided for convenience.
*/

    public AudioChannelDescription(int index, java.util.HashMap<com.trolltech.qt.core.QByteArray, java.lang.Object> properties){
        super((QPrivateConstructor)null);
        __qt_AudioChannelDescription_int_HashMap(index, properties);
    }

    native void __qt_AudioChannelDescription_int_HashMap(int index, java.util.HashMap<com.trolltech.qt.core.QByteArray, java.lang.Object> properties);
...
*/
    ...
    @QtBlockedSlot
    private final boolean operator_equal(com.trolltech.qt.phonon.AudioChannelDescription otherDescription)    {
        if (nativeId() == 0)
            throw new QNoNativeResourcesException("Function call on incomplete object of type: " +getClass().getName());
...
*/
    ...
    public static native AudioChannelDescription fromNativePointer(QNativePointer nativePointer);
...
*/
    ...
    protected AudioChannelDescription(QPrivateConstructor p) { super(p); } 

/**
@exclude
*/

    public static native QNativePointer nativePointerArray(AudioChannelDescription array[]);
...
*/
    ...
    if (other instanceof com.trolltech.qt.phonon.AudioChannelDescription)
        return operator_equal((com.trolltech.qt.phonon.AudioChannelDescription) other);
        return false;
    }
    ...
    @Override
    public AudioChannelDescription clone() {
        if (nativeId() == 0)
            throw new QNoNativeResourcesException("Function call on incomplete object of type: " +getClass().getName());
        return __qt_clone(nativeId());
    }
    native AudioChannelDescription __qt_clone(long __this_nativeId);
}
