...
public class EffectDescription extends com.trolltech.qt.QtJambiObject
...
*/
    ...
    public EffectDescription(){
        ...
        __qt_EffectDescription();
    }

    native void __qt_EffectDescription();

/**

*/

    public EffectDescription(int index, java.util.HashMap<com.trolltech.qt.core.QByteArray, java.lang.Object> properties){
        super((QPrivateConstructor)null);
        __qt_EffectDescription_int_HashMap(index, properties);
    }

    native void __qt_EffectDescription_int_HashMap(int index, java.util.HashMap<com.trolltech.qt.core.QByteArray, java.lang.Object> properties);
...
*/
    ...
    @QtBlockedSlot
    private final boolean operator_equal(com.trolltech.qt.phonon.EffectDescription otherDescription)    {
        if (nativeId() == 0)
            throw new QNoNativeResourcesException("Function call on incomplete object of type: " +getClass().getName());
...
*/
    ...
    public static native EffectDescription fromNativePointer(QNativePointer nativePointer);
...
*/
    ...
    protected EffectDescription(QPrivateConstructor p) { super(p); } 

/**
@exclude
*/

    public static native QNativePointer nativePointerArray(EffectDescription array[]);
...
*/
    ...
    if (other instanceof com.trolltech.qt.phonon.EffectDescription)
        return operator_equal((com.trolltech.qt.phonon.EffectDescription) other);
        return false;
    }
    ...
    native EffectDescription __qt_clone(long __this_nativeId);
}
