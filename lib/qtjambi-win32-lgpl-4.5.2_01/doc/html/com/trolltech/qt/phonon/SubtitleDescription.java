...
public class SubtitleDescription extends com.trolltech.qt.QtJambiObject
...
*/
    ...
    public SubtitleDescription(){
        super((QPrivateConstructor)null);
        __qt_SubtitleDescription();
    }

    native void __qt_SubtitleDescription();

/**
This is an overloaded method provided for convenience.
*/

    public SubtitleDescription(int index, java.util.HashMap<com.trolltech.qt.core.QByteArray, java.lang.Object> properties){
        super((QPrivateConstructor)null);
        __qt_SubtitleDescription_int_HashMap(index, properties);
    }

    native void __qt_SubtitleDescription_int_HashMap(int index, java.util.HashMap<com.trolltech.qt.core.QByteArray, java.lang.Object> properties);
...
*/
    ...
    @QtBlockedSlot
    private final boolean operator_equal(com.trolltech.qt.phonon.SubtitleDescription otherDescription)    {
        if (nativeId() == 0)
            throw new QNoNativeResourcesException("Function call on incomplete object of type: " +getClass().getName());
...
*/
    ...
    public static native SubtitleDescription fromNativePointer(QNativePointer nativePointer);
...
*/
    ...
    protected SubtitleDescription(QPrivateConstructor p) { super(p); } 

/**
@exclude
*/

    public static native QNativePointer nativePointerArray(SubtitleDescription array[]);
...
*/
    ...
    if (other instanceof com.trolltech.qt.phonon.SubtitleDescription)
        return operator_equal((com.trolltech.qt.phonon.SubtitleDescription) other);
        return false;
    }
    ...
    @Override
    public SubtitleDescription clone() {
        if (nativeId() == 0)
            throw new QNoNativeResourcesException("Function call on incomplete object of type: " +getClass().getName());
        return __qt_clone(nativeId());
    }
    native SubtitleDescription __qt_clone(long __this_nativeId);
}
