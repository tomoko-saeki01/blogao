...
/**
The QGraphicsSvgItem class is a {@link com.trolltech.qt.gui.QGraphicsItem QGraphicsItem} that can be used to render the contents of SVG files. QGraphicsSvgItem provides a way of rendering SVG files onto {@link com.trolltech.qt.gui.QGraphicsView QGraphicsView}. QGraphicsSvgItem can be created by passing the SVG file to be rendered to its constructor or by explicit setting a shared {@link com.trolltech.qt.svg.QSvgRenderer QSvgRenderer} on it. <p>Note that setting {@link com.trolltech.qt.svg.QSvgRenderer QSvgRenderer} on a QGraphicsSvgItem doesn't make the item take ownership of the renderer, therefore if using {@link com.trolltech.qt.svg.QGraphicsSvgItem#setSharedRenderer(com.trolltech.qt.svg.QSvgRenderer) setSharedRenderer()} method one has to make sure that the lifetime of the {@link com.trolltech.qt.svg.QSvgRenderer QSvgRenderer} object will be at least as long as that of the QGraphicsSvgItem. <p>QGraphicsSvgItem provides a way of rendering only parts of the SVG files via the setElementId. If {@link com.trolltech.qt.svg.QGraphicsSvgItem#setElementId(java.lang.String) setElementId()} method is called, only the SVG element (and its children) with the passed id will be renderer. This provides a convenient way of selectively rendering large SVG files that contain a number of discrete elements. For example the following code renders only jokers from a SVG file containing a whole card deck: <pre class="snippet">
...
</pre> Size of the item can be set via the setSize() method or via direct manipulation of the items transformation matrix. <p>By default the SVG rendering is cached using {@link com.trolltech.qt.gui.QGraphicsItem.CacheMode QGraphicsItem::DeviceCoordinateCache } mode to speedup the display of items. Caching can be disabled by passing {@link com.trolltech.qt.gui.QGraphicsItem.CacheMode QGraphicsItem::NoCache } to the {@link com.trolltech.qt.gui.QGraphicsItem#setCacheMode(com.trolltech.qt.gui.QGraphicsItem.CacheMode) QGraphicsItem::setCacheMode()} method. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.svg.QSvgWidget QSvgWidget}, {@link <a href="../qtsvg.html">QtSvg Module</a>}, {@link com.trolltech.qt.gui.QGraphicsItem QGraphicsItem}, and {@link com.trolltech.qt.gui.QGraphicsView QGraphicsView}. <br></DD></DT>
*/
@QtJambiGeneratedClass
public class QGraphicsSvgItem extends com.trolltech.qt.core.QObject
...
/**
<brief>Returns the QGraphicsSvgItem$enum_1 constant with the specified <tt>int</tt>.</brief>
*/
...
/**
Constructs a new SVG item with the given <tt>parent</tt>.
*/

    public QGraphicsSvgItem() {
        this((com.trolltech.qt.gui.QGraphicsItem)null);
    }
/**
Constructs a new SVG item with the given <tt>parent</tt>.
*/

    public QGraphicsSvgItem(com.trolltech.qt.gui.QGraphicsItemInterface parentItem){
        super((QPrivateConstructor)null);
        __qt_QGraphicsSvgItem_QGraphicsItem(parentItem == null ? 0 : parentItem.nativeId());
        if (parentItem != null) disableGarbageCollection();


    }

    native void __qt_QGraphicsSvgItem_QGraphicsItem(long parentItem);


/**
Constructs a new item with the given <tt>parent</tt> and loads the contents of the SVG file with the specified <tt>fileName</tt>.
*/

    public QGraphicsSvgItem(java.lang.String fileName) {
        this(fileName, (com.trolltech.qt.gui.QGraphicsItem)null);
    }
/**
Constructs a new item with the given <tt>parent</tt> and loads the contents of the SVG file with the specified <tt>fileName</tt>.
*/

    public QGraphicsSvgItem(java.lang.String fileName, com.trolltech.qt.gui.QGraphicsItemInterface parentItem){
        super((QPrivateConstructor)null);
        __qt_QGraphicsSvgItem_String_QGraphicsItem(fileName, parentItem == null ? 0 : parentItem.nativeId());
        if (parentItem != null) disableGarbageCollection();


    }

    native void __qt_QGraphicsSvgItem_String_QGraphicsItem(java.lang.String fileName, long parentItem);
...
/**
Returns the XML ID the element that is currently being renderer. Returns an empty string if the whole file is being rendered. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.svg.QGraphicsSvgItem#setElementId(java.lang.String) setElementId()}. <br></DD></DT>
*/
    ...
    @QtBlockedSlot
    native java.lang.String __qt_elementId(long __this__nativeId);
...
/**
Use {@link com.trolltech.qt.gui.QGraphicsItem#cacheMode() QGraphicsItem::cacheMode()} instead.
*/
    ...
    @QtBlockedSlot
    native boolean __qt_isCachingEnabled(long __this__nativeId);
...
/**
Returns the current maximum size of the device coordinate cache for this item. If the item is cached using {@link com.trolltech.qt.gui.QGraphicsItem.CacheMode QGraphicsItem::DeviceCoordinateCache } mode, caching is bypassed if the extension of the item in device coordinates is larger than the maximum size. <p>The default maximum cache size is 1024x768. {@link com.trolltech.qt.gui.QPixmapCache#cacheLimit() QPixmapCache::cacheLimit()} gives the cumulative bounds of the whole cache, whereas {@link com.trolltech.qt.svg.QGraphicsSvgItem#maximumCacheSize() maximumCacheSize()} refers to a maximum cache size for this particular item. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.svg.QGraphicsSvgItem#setMaximumCacheSize(com.trolltech.qt.core.QSize) setMaximumCacheSize()}, and {@link com.trolltech.qt.gui.QGraphicsItem#cacheMode() QGraphicsItem::cacheMode()}. <br></DD></DT>
*/

    @QtBlockedSlot
    public final com.trolltech.qt.core.QSize maximumCacheSize()    {
        com.trolltech.qt.GeneratorUtilities.threadCheck(this);
        if (nativeId() == 0)
            throw new QNoNativeResourcesException("Function call on incomplete object of type: " +getClass().getName());
    ...
    @QtBlockedSlot
    native com.trolltech.qt.core.QSize __qt_maximumCacheSize(long __this__nativeId);
...
/**
Returns the currently use {@link com.trolltech.qt.svg.QSvgRenderer QSvgRenderer}.
*/
...
/**
Use {@link com.trolltech.qt.gui.QGraphicsItem#setCacheMode(com.trolltech.qt.gui.QGraphicsItem.CacheMode) QGraphicsItem::setCacheMode()} instead. Passing true to this function is equivalent to QGraphicsItem::setCacheMode({@link com.trolltech.qt.gui.QGraphicsItem.CacheMode QGraphicsItem::DeviceCoordinateCache }). <p><DT><b>See also:</b><br><DD>isCachingEnabled(). <br></DD></DT>
*/
    ...
    public final void setCachingEnabled(boolean arg__1)    {
        ...
        if (nativeId() == 0)
            throw new QNoNativeResourcesException("Function call on incomplete object of type: " +getClass().getName());
        __qt_setCachingEnabled_boolean(nativeId(), arg__1);
    }
    @QtBlockedSlot
    native void __qt_setCachingEnabled_boolean(long __this__nativeId, boolean arg__1);
...
/**
Sets the XML ID of the element that this item should render to <tt>id</tt>. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.svg.QGraphicsSvgItem#elementId() elementId()}. <br></DD></DT>
*/
    ...
    public final void setElementId(java.lang.String id)    {
        ...
        if (nativeId() == 0)
            throw new QNoNativeResourcesException("Function call on incomplete object of type: " +getClass().getName());
        __qt_setElementId_String(nativeId(), id);
    }
    @QtBlockedSlot
    native void __qt_setElementId_String(long __this__nativeId, java.lang.String id);
...
/**
Sets the maximum device coordinate cache size of the item to <tt>size</tt>. If the item is cached using {@link com.trolltech.qt.gui.QGraphicsItem.CacheMode QGraphicsItem::DeviceCoordinateCache } mode, caching is bypassed if the extension of the item in device coordinates is larger than <tt>size</tt>. <p>The cache corresponds to the {@link com.trolltech.qt.gui.QPixmap QPixmap} which is used to cache the results of the rendering. Use {@link com.trolltech.qt.gui.QPixmapCache#setCacheLimit(int) QPixmapCache::setCacheLimit()} to set limitations on the whole cache and use {@link com.trolltech.qt.svg.QGraphicsSvgItem#setMaximumCacheSize(com.trolltech.qt.core.QSize) setMaximumCacheSize()} when setting cache size for individual items. <p><DT><b>See also:</b><br><DD>{@link com.trolltech.qt.svg.QGraphicsSvgItem#maximumCacheSize() maximumCacheSize()}, and {@link com.trolltech.qt.gui.QGraphicsItem#cacheMode() QGraphicsItem::cacheMode()}. <br></DD></DT>
*/

    @QtBlockedSlot
    public final void setMaximumCacheSize(com.trolltech.qt.core.QSize size)    {
        com.trolltech.qt.GeneratorUtilities.threadCheck(this);
        if (nativeId() == 0)
            throw new QNoNativeResourcesException("Function call on incomplete object of type: " +getClass().getName());
        __qt_setMaximumCacheSize_QSize(nativeId(), size == null ? 0 : size.nativeId());
    }
    @QtBlockedSlot
    native void __qt_setMaximumCacheSize_QSize(long __this__nativeId, long size);
...
/**
Sets <tt>renderer</tt> to be a shared {@link com.trolltech.qt.svg.QSvgRenderer QSvgRenderer} on the item. By using this method one can share the same {@link com.trolltech.qt.svg.QSvgRenderer QSvgRenderer} on a number of items. This means that the SVG file will be parsed only once. {@link com.trolltech.qt.svg.QSvgRenderer QSvgRenderer} passed to this method has to exist for as long as this item is used.
*/

    @QtBlockedSlot
    public final void setSharedRenderer(com.trolltech.qt.svg.QSvgRenderer renderer)    {
        QSvgRenderer oldRenderer = renderer();


        com.trolltech.qt.GeneratorUtilities.threadCheck(this);
        if (renderer != null) {
            renderer.disableGarbageCollection();
        }
        if (nativeId() == 0)
            throw new QNoNativeResourcesException("Function call on incomplete object of type: " +getClass().getName());
        __qt_setSharedRenderer_QSvgRenderer(nativeId(), renderer == null ? 0 : renderer.nativeId());
        if (oldRenderer != null)
    ...
    @QtBlockedSlot
    native void __qt_setSharedRenderer_QSvgRenderer(long __this__nativeId, long renderer);
...
*/
    ...
    public static native QGraphicsSvgItem fromNativePointer(QNativePointer nativePointer);
